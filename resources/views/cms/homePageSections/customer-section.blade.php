                        ...
                        <div class="card">
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    ...
                                    @endif 
                                    @if(!empty($sections))
                                    <form class="form" action="{{route('updateSections', $sections['id'])}}" method="POST" enctype="multipart/form-data" id="customerSection">
                                        @csrf
                                        @method('PUT')                                           
                                     @else
                                    <form class="form" action="{{route('submit')}}" method="POST" enctype="multipart/form-data" id="customerSection">
                                        @csrf 
                                     @endif
                                        <div class="form-body">
                                            <h4 class="form-section">Customer Section</h4>
                                            ...
                                            <input type="hidden" name="route_name" value="customer-section">
                                        </div>
